...
![World of Warcraft Server Website](wow1.powerpuff.pro.png)

[![Смотреть демо](https://img.shields.io/badge/🎮%20Смотреть%20демо-ECA84C?style=for-the-badge&logo=worldofwarcraft&logoColor=white)](https://wow1.powerpuff.pro)

</div>

# World of Warcraft Server Website

Веб-сайт для сервера World of Warcraft на базе Laravel 11.
...
### 8. Настройка Google reCAPTCHA v3

Для защиты форм регистрации и авторизации используется Google reCAPTCHA v3.
...
**Примечание:** 
- `RECAPTCHA_MIN_SCORE` определяет минимальный балл (от 0.0 до 1.0) для прохождения проверки. Рекомендуемое значение: 0.5
- Если ключи не настроены, проверка reCAPTCHA будет пропущена (для разработки)
